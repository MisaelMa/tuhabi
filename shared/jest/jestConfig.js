module.exports = {
  ...
  transform: {
    ...
    '\\.*Worker.ts$':
      './node_modules/@ammc/jest/jestBabelTransform',
  ...
  setupFilesAfterEnv: ['./node_modules/@ammc/jest/setupTests.ts'],
  setupFiles: ['./node_modules/@ammc/jest/jest.env.js'],
  ...
  moduleNameMapper: {
    ...
    '^@ammc/([^/]+)/(.*)$':
      '<rootDir>/node_modules/@ammc/$1/src/$2',
  },
